 ...
 * @author RoyalRode
 */
@WebServlet(name = "LoginTra", urlPatterns = {"/LoginTra"})
public class LoginTra extends HttpServlet {
        ...
        if( correo!= null && pass!= null ){
            try {
             Trabajador tra = Conexion.LoginTrabajador(correo, pass);
                ...
                Logger.getLogger(LoginTra.class.getName()).log(Level.SEVERE, null, ex);
            }
