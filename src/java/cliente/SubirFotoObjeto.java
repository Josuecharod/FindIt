 ...
 * @author RoyalRode
 */
@WebServlet(name = "SubirFotoObjeto", urlPatterns = {"/SubirFotoObjeto"})
public class SubirFotoObjeto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Part parte = request.getPart("fotoObjeto");
        ...
        int id_objeto = Integer.parseInt(request.getParameter("id"));
        
        Conexion.SubirFotoObjeto(id_objeto,nombreFichero);
        
         session.removeAttribute("verHistorialObjetos");
